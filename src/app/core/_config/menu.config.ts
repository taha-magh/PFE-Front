	...
	public defaults: any = {
		...
		header: {
			...
			items: [
				...
				// 	submenu: [
				// 		{
				// 			title: "Add Paramaitre",
				// 			translate: "Ajouter paramètre",
		...
		header_RH: {
			...
			items: [
				...
				// 		{
				// 			title: "Notaire",
				// 			translate: "liste des notaires",
				// 			page: "/pages/contrats/notaire",
				// 			icon: "flaticon2-list-3",
				// 			//permission: "accessToIndexAssociation",
				// 		},
				// 		{
				// 			title: "Huissier de justice",
				// 			translate: "liste des huissiers de justice",
				// 			page: "/pages/contrats/commissaire-judiciaire",
				// 			icon: "flaticon2-list-3",
				// 			//permission: "accessToIndexAssociation",
				// 		},
				// 		{
				// 			title: "expert",
				// 			translate: "liste des experts judiciare",
				// 			page: "/pages/contrats/expert",
				// 			icon: "flaticon2-list-3",
				// 			//permission: "accessToIndexAssociation",
				// 		},
				// 	],
