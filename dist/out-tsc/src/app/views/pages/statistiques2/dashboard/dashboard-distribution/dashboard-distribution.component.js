...
var DashboardDistributionComponent = /** @class */ (function () {
    // ============================================
    // constructeur
    // ============================================
    function DashboardDistributionComponent(fb, translate, datePipe) {
        this.fb = fb;
    ...
    // ngOninit
    // ============================================
    DashboardDistributionComponent.prototype.ngOnInit = function () {
    ...
    // ngAfterView
    // ============================================
    DashboardDistributionComponent.prototype.ngAfterViewInit = function () {
        //	this.data.map((data) => data.num);
        var nbrAssoc = ["5", "0", "4", "1", "1"];
    ...
    // OnSubmit
    // ============================================
    DashboardDistributionComponent.prototype.onSubmit = function () {
    };
    DashboardDistributionComponent.prototype.selectAssoication = function (event) {
    ...
    // ============================================
    DashboardDistributionComponent.prototype.fillChartByParam = function (type, commune, chartType, dateD, dateF) {
        var _this = this;
    };
    // ============================================
    // Charger les liste externe
    // ============================================
    DashboardDistributionComponent.prototype.getDataDropDownList = function () {
    ...
    // OnChange radio
    // ============================================
    DashboardDistributionComponent.prototype.selectionChanged = function (event) {
    ...
    DashboardDistributionComponent.prototype.selectionChanged1 = function (event) {
    ...
    //ngAfterView
    // ============================================
    DashboardDistributionComponent.prototype.getCharts = function () {
    };
    // ============================================
    //
    // ============================================
    DashboardDistributionComponent.prototype.getRandomNumber = function (min, max) {
        return Math.floor(Math.random() * (+max - +min)) + +min;
    };
    // ============================================
    // Download graphe
    // ============================================
    DashboardDistributionComponent.prototype.downloadCanvas = function (event) {
    ...
    // ============================================
    DashboardDistributionComponent.prototype.refresh = function () {
    ...
    // ChartJs
    // ===========================================
    DashboardDistributionComponent.prototype.chartOption = function (libelle, id, type) {
        var _this_1 = this;
        var ctx = document.getElementById('canvas9');
    ...
    DashboardDistributionComponent.prototype.chartOptionAssocation = function (libelle, id, type) {
        var _this_1 = this;
    ...
    ], DashboardDistributionComponent.prototype, "paginator", void 0);
    tslib_1.__decorate([
        ViewChild(MatSort, { static: true }),
        tslib_1.__metadata("design:type", MatSort)
    ], DashboardDistributionComponent.prototype, "sort", void 0);
    DashboardDistributionComponent = tslib_1.__decorate([
        Component({
            selector: 'kt-dashboard-distribution',
        ...
        tslib_1.__metadata("design:paramtypes", [FormBuilder,
            TranslateService,
            DatePipe])
    ], DashboardDistributionComponent);
    return DashboardDistributionComponent;
}());
export { DashboardDistributionComponent };
//# sourceMappingURL=dashboard-distribution.component.js.map