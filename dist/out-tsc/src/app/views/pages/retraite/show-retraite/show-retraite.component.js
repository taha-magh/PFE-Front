...
var ShowRetraiteComponent = /** @class */ (function () {
    // ============================================
    // Constructeur
    // ============================================
    function ShowRetraiteComponent(service, router, route, translate, fileService, spinnerService) {
    ...
    // =====================================
    ShowRetraiteComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.details = {
            num: "1/2022",
            nom: "nom affaire 1 ",
    ...
    // back to list
    // =====================================
    ShowRetraiteComponent.prototype.back = function () {
        //this.location.back();
    ...
    ], ShowRetraiteComponent.prototype, "accordion", void 0);
    ShowRetraiteComponent = tslib_1.__decorate([
        Component({
            selector: "kt-show-retraite",
            templateUrl: "./show-retraite.component.html",
            styleUrls: ["./show-retraite.component.scss"],
        }),
        tslib_1.__metadata("design:paramtypes", [AssociationService,
            ...
            FilesUtilsService,
            SpinnerService])
    ], ShowRetraiteComponent);
    return ShowRetraiteComponent;
}());
export { ShowRetraiteComponent };
//# sourceMappingURL=show-retraite.component.js.map