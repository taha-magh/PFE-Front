...
var ListPesonnelCommuneComponent = /** @class */ (function () {
    function ListPesonnelCommuneComponent(translate, router, datePipe, excelService) {
    ...
    ListPesonnelCommuneComponent.prototype.ngOnInit = function () {
        this.columns = [
            "NUM",
            "Nom",
            "Prenom",
    ...
    ListPesonnelCommuneComponent.prototype.applyFilter = function (filterValue) {
    ...
    // }
    ListPesonnelCommuneComponent.prototype.EtapeDernier = function () {
        this.router.navigate(["pages/affaires/dashboard"]);
    };
    ListPesonnelCommuneComponent.prototype.Details = function () {
        this.router.navigate(["pages/personnel/show-personnel"]);
    };
    ListPesonnelCommuneComponent.prototype.Edit = function () {
        this.router.navigate(["pages/personnel/edit-personnel"]);
    };
    ListPesonnelCommuneComponent.prototype.Add = function () {
        this.router.navigate(["pages/personnel/add-personnel"]);
    };
    ListPesonnelCommuneComponent.prototype.createDataJson = function (i) {
        return {
    ...
    ], ListPesonnelCommuneComponent.prototype, "paginator", void 0);
    tslib_1.__decorate([
        ViewChild(MatSort, { static: true }),
        tslib_1.__metadata("design:type", MatSort)
    ], ListPesonnelCommuneComponent.prototype, "sort", void 0);
    ListPesonnelCommuneComponent = tslib_1.__decorate([
        Component({
    ...
    return ListPesonnelCommuneComponent;
}());
export { ListPesonnelCommuneComponent };
//# sourceMappingURL=list-pesonnel-commune.component.js.map