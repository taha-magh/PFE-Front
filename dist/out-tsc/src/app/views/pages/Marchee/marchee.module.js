...
var MarcheeModule = /** @class */ (function () {
    function MarcheeModule() {
    }
    MarcheeModule = tslib_1.__decorate([
        NgModule({
            declarations: [
                MarcheeComponent,
    ...
    return MarcheeModule;
}());
export { MarcheeModule };
//# sourceMappingURL=marchee.module.js.map