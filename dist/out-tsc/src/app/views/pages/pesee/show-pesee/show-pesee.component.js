...
var ShowPeseeComponent = /** @class */ (function () {
    // ============================================
    // Constructeur
    // ============================================
    function ShowPeseeComponent(service, router, route, translate, fileService, spinnerService) {
    ...
    // =====================================
    ShowPeseeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.details = {
            "num": "1/2022",
            "nom": "nom affaire 1 ",
    ...
    // back to list
    // =====================================
    ShowPeseeComponent.prototype.back = function () {
        //this.location.back();
    ...
    ], ShowPeseeComponent.prototype, "accordion", void 0);
    ShowPeseeComponent = tslib_1.__decorate([
        Component({
    ...
    return ShowPeseeComponent;
}());
export { ShowPeseeComponent };
//# sourceMappingURL=show-pesee.component.js.map