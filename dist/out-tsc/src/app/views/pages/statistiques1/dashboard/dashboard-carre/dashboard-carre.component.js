...
var DashboardCarreComponent = /** @class */ (function () {
    // ============================================
    // constructeur
    // ============================================
    function DashboardCarreComponent(fb, translate, datePipe) {
        this.fb = fb;
    ...
    // ngOninit
    // ============================================
    DashboardCarreComponent.prototype.ngOnInit = function () {
    ...
    // ngAfterView
    // ============================================
    DashboardCarreComponent.prototype.ngAfterViewInit = function () {
    ...
    // OnSubmit
    // ============================================
    DashboardCarreComponent.prototype.onSubmit = function () {
    };
    DashboardCarreComponent.prototype.selectAssoication = function (event) {
    ...
    // ============================================
    DashboardCarreComponent.prototype.fillChartByParam = function (type, commune, chartType, dateD, dateF) {
        var _this = this;
    };
    // ============================================
    // Charger les liste externe
    // ============================================
    DashboardCarreComponent.prototype.getDataDropDownList = function () {
    ...
    // OnChange radio
    // ============================================
    DashboardCarreComponent.prototype.selectionChanged = function (event) {
    ...
    DashboardCarreComponent.prototype.selectionChanged1 = function (event) {
    ...
    //ngAfterView
    // ============================================
    DashboardCarreComponent.prototype.getCharts = function () {
    };
    // ============================================
    //
    // ============================================
    DashboardCarreComponent.prototype.getRandomNumber = function (min, max) {
        return Math.floor(Math.random() * (+max - +min)) + +min;
    };
    // ============================================
    // Download graphe
    // ============================================
    DashboardCarreComponent.prototype.downloadCanvas = function (event) {
    ...
    // ============================================
    DashboardCarreComponent.prototype.refresh = function () {
    ...
    // ChartJs
    // ===========================================
    DashboardCarreComponent.prototype.chartOption = function (libelle, id, type) {
        var _this_1 = this;
    ...
    DashboardCarreComponent.prototype.chartOptionAssocation = function (libelle, id, type) {
        var _this_1 = this;
    ...
    ], DashboardCarreComponent.prototype, "paginator", void 0);
    tslib_1.__decorate([
        ViewChild(MatSort, { static: true }),
        tslib_1.__metadata("design:type", MatSort)
    ], DashboardCarreComponent.prototype, "sort", void 0);
    DashboardCarreComponent = tslib_1.__decorate([
        Component({
            selector: 'kt-dashboard-carre',
            templateUrl: './dashboard-carre.component.html',
            styleUrls: ['./dashboard-carre.component.scss']
        }),
        tslib_1.__metadata("design:paramtypes", [FormBuilder,
            TranslateService,
            DatePipe])
    ], DashboardCarreComponent);
    return DashboardCarreComponent;
}());
export { DashboardCarreComponent };
//# sourceMappingURL=dashboard-carre.component.js.map