...
var ListTarifsComponent = /** @class */ (function () {
    // ============================================
    // Constructeur
    // ============================================
    function ListTarifsComponent(translate, router, datePipe, excelService) {
    ...
    ListTarifsComponent.prototype.ngOnInit = function () {
        this.columns = ["num",
            "nom",
            "defendresse",
            "tribunal",
    ...
    // Filter de recherche
    // ============================================
    ListTarifsComponent.prototype.applyFilter = function (filterValue) {
    ...
    // ============================================
    ListTarifsComponent.prototype.addAssociation = function () {
        this.router.navigate(["pages/audiences/edit-tarifs"]);
    };
    ListTarifsComponent.prototype.add = function () {
        this.router.navigate(["pages/audiences/add-tarifs"]);
    };
    ListTarifsComponent.prototype.consulterDetail = function () {
        this.router.navigate(["pages/affaires/show-affaire"]);
    };
    ListTarifsComponent.prototype.deleteAssociation = function (id) {
        var _this = this;
        Swal.fire({
    ...
    // ============================================
    ListTarifsComponent.prototype.exportTable = function () {
    ...
    ListTarifsComponent.prototype.createDataJson = function (i) {
        return {
    ...
    ], ListTarifsComponent.prototype, "paginator", void 0);
    tslib_1.__decorate([
        ViewChild(MatSort, { static: true }),
        tslib_1.__metadata("design:type", MatSort)
    ], ListTarifsComponent.prototype, "sort", void 0);
    ListTarifsComponent = tslib_1.__decorate([
        Component({
    ...
    return ListTarifsComponent;
}());
export { ListTarifsComponent };
//# sourceMappingURL=list-tarifs.component.js.map