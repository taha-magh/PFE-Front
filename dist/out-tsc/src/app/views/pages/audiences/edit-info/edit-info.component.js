...
var EditInfoComponent = /** @class */ (function () {
    ...
    // Constructeur
    // ============================================
    function EditInfoComponent(translate, router, datePipe, excelService) {
    ...
    // Filter de recherche
    // ============================================
    EditInfoComponent.prototype.applyFilter = function (filterValue) {
    ...
    // ============================================
    EditInfoComponent.prototype.addAssociation = function () {
    };
    EditInfoComponent.prototype.add = function () {
        this.router.navigate(["pages/audiences/saisir-info"]);
    };
    EditInfoComponent.prototype.back = function () {
        this.router.navigate(["pages/audiences/list-info"]);
    };
    EditInfoComponent.prototype.deleteAssociation = function (id) {
        var _this = this;
        Swal.fire({
    ...
    // ============================================
    EditInfoComponent.prototype.exportTable = function () {
    ...
    EditInfoComponent.prototype.createDataJson = function (i) {
        return {
    ...
    ], EditInfoComponent.prototype, "paginator", void 0);
    tslib_1.__decorate([
        ViewChild(MatSort, { static: true }),
        tslib_1.__metadata("design:type", MatSort)
    ], EditInfoComponent.prototype, "sort", void 0);
    EditInfoComponent = tslib_1.__decorate([
        Component({
