...
var AddFactureComponent = /** @class */ (function () {
    ...
    // Constructeur
    // ============================================
    function AddFactureComponent(translate, router, datePipe, excelService) {
    ...
    // Filter de recherche
    // ============================================
    AddFactureComponent.prototype.applyFilter = function (filterValue) {
    ...
    AddFactureComponent.prototype.back = function () {
        this.router.navigate(["pages/audiences/list-facture"]);
    };
    AddFactureComponent.prototype.deleteAssociation = function (id) {
        var _this = this;
        Swal.fire({
    ...
    // ============================================
    AddFactureComponent.prototype.exportTable = function () {
    ...
    AddFactureComponent.prototype.createDataJson = function (i) {
        return {
    ...
    ], AddFactureComponent.prototype, "paginator", void 0);
    tslib_1.__decorate([
        ViewChild(MatSort, { static: true }),
        tslib_1.__metadata("design:type", MatSort)
    ], AddFactureComponent.prototype, "sort", void 0);
    AddFactureComponent = tslib_1.__decorate([
        Component({
            selector: 'kt-add-facture',
...
export { AddFactureComponent };
//# sourceMappingURL=add-facture.component.js.map