...
var StatisticsComponent = /** @class */ (function () {
    ...
    // constructeur
    // ============================================
    function StatisticsComponent(fb, translate, datePipe, router) {
        this.fb = fb;
    ...
    StatisticsComponent.prototype.EtapeDernier = function () {
    ...
    // OnSubmit
    // ============================================
    StatisticsComponent.prototype.onSubmit = function () { };
    StatisticsComponent.prototype.selectAssoication = function (event) {
    ...
    // ============================================
    StatisticsComponent.prototype.fillChartByParam = function (type, commune, chartType, dateD, dateF) {
        var _this = this;
    };
    // ============================================
    // Charger les liste externe
    // ============================================
    StatisticsComponent.prototype.getDataDropDownList = function () {
    ...
    // OnChange radio
    // ============================================
    StatisticsComponent.prototype.selectionChanged = function (event) {
    ...
    StatisticsComponent.prototype.selectionChanged1 = function (event) {
    ...
    //ngAfterView
    // ============================================
    StatisticsComponent.prototype.getCharts = function () { };
    // ============================================
    // get data
    // ============================================
    // ============================================
    //
    // ============================================
    StatisticsComponent.prototype.getDataSource = function (data) {
    ...
    //
    // ============================================
    StatisticsComponent.prototype.getRandomNumber = function (min, max) {
        return Math.floor(Math.random() * (+max - +min)) + +min;
    };
    // ============================================
    // Download graphe
    // ============================================
    StatisticsComponent.prototype.downloadCanvas = function (event) {
    ...
    // ChartJs
    // ===========================================
    StatisticsComponent.prototype.chartOption = function (libelle, id, type) {
        var _this_1 = this;
    ...
    StatisticsComponent.prototype.chartOptionAssocation = function (libelle, id, type) {
        var _this_1 = this;
    ...
    ], StatisticsComponent.prototype, "paginator", void 0);
    tslib_1.__decorate([
        ViewChild(MatSort, { static: true }),
        tslib_1.__metadata("design:type", MatSort)
    ], StatisticsComponent.prototype, "sort", void 0);
    StatisticsComponent = tslib_1.__decorate([
        Component({
